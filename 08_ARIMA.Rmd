...
## Ejercicios
1) Se tienen 57 mediciones consecutivas de una máquina que están en el objeto $deere3$ del paquete TSA:
...
g. Apliqué un autoarima y comparé respecto a lo que esperaba derivado del análisis de los correlogramas realizados en el ejercicio 6.3.3